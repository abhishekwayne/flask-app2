...
def menu():
    ...
    while True:
        ...
        region_name = input("Enter a number from [1-5]: ")
        if not 1 <= int(region_name) <= 5:
...
def get_image_id(region_name):
    ...
    filters = [
        {'Name': 'owner-id', 'Values': ['805954914202']},
        {'Name': 'description', 'Values': ['Amazon Linux 2 Kernel 5.10 AMI 2.0.20220805.0 x86_64 HVM gp2']}
    ]
